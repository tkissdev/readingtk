...
const fr: Dict = {
  ...
  "landing.openSource": "Projet open source — voir le code sur GitHub",
  ...
  "drawer.scrapeError": "Échec côté application Windows : {message}",
  "drawer.scrapingWindows": "Scan en cours depuis l'application Windows",
  "drawer.scrapingExtension": "Scan en cours depuis l'extension",
...
const en: Dict = {
  ...
  "landing.openSource": "Open source project — view the code on GitHub",
  "landing.extensions": "Download et Extension",
  ...
  "drawer.scrapeError": "Windows app check failed: {message}",
  "drawer.scrapingWindows": "Scanning via the Windows app",
  "drawer.scrapingExtension": "Scanning via the extension",
