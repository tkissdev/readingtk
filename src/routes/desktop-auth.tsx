...
const OAUTH_PROVIDERS: {
...
}[] = [
  {
    id: "google",
    label: "Google",
    color: "hover:border-[#4285F4]/50 hover:bg-[#4285F4]/10",
    icon: (
  ...
  },
  {
    id: "discord",
    label: "Discord",
    color: "hover:border-[#5865F2]/50 hover:bg-[#5865F2]/10",
    icon: (
  ...
  },
  {
    id: "twitch",
    label: "Twitch",
    color: "hover:border-[#9146FF]/50 hover:bg-[#9146FF]/10",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
...
function DesktopAuthPage() {
  ...
  const [phase, setPhase] = useState<
    "checking" | "connected" | "login" | "sending" | "done" | "error"
  >("checking");
  ...
  async function sendSession(session: object) {
    ...
    try {
      ...
      setErrorMsg(
        "Impossible de contacter l'application Windows. Assurez-vous qu'elle est lancée.",
      );
      setPhase("error");
    }
  }
  ...
  return (
    ...
    >
      <div className="w-full max-w-md">
        ...
        <div
          className="rounded-2xl border border-border/60 bg-card/80 p-8 backdrop-blur"
          ...
          {phase === "connected" && (
            <>
              ...
              <p className="mt-1 text-sm text-muted-foreground mb-6">
                Vous êtes déjà connecté. Cliquez pour autoriser l'application.
              </p>
              <button
          ...
          {phase === "login" && (
            <>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Pour l'application Windows ReadingTK
              </p>
