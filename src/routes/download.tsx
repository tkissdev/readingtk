  ...
  head: () => ({
    meta: [
      { title: "Téléchargements · ReadingTK" },
      {
        name: "description",
        content:
          "Téléchargez l'extension ReadingTK (Chrome, Firefox) et l'application Windows pour détecter automatiquement les nouveaux chapitres manga et manhwa.",
      },
    ],
  }),
...
const RELEASE_BASE = "https://github.com/tkissdev/readingtk/releases/download/windows-app-v1.0.7";
const WINDOWS_VERSION = "1.0.7";
...
const ChromeIcon = () => (
  <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
    ...
    <path
      d="M3.46 14A10 10 0 0 0 12 22l4.6-7.96A4 4 0 0 1 12 16a4 4 0 0 1-3.46-2H3.46z"
      fill="#34a853"
    />
...
const FirefoxIcon = () => (
  <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
    ...
    <path
      d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm3.5 14.5c-1 .7-2.2 1-3.5 1-3.87 0-7-3.13-7-7 0-1.5.47-2.89 1.27-4.03.2.6.5 1.5 1.23 2.03.9.65 2 .5 2 .5s-.5 1 .5 2c.67.67 1.5.7 2 .5.4 1.2 1.5 2 2.5 2s2-.8 2-2c0-.5-.2-1-.5-1.5.5.2 1 .6 1.3 1.2.8 1.5.4 3.5-1.8 5.3z"
      fill="#FF6611"
    />
  </svg>
);
    ...
    ? [
        {
          ...
          desc: "Clique sur le bouton ci-dessus pour télécharger le fichier ZIP.",
        },
        {
          title: "Ouvre la page des extensions",
          desc: "Dans Chrome : tape chrome://extensions dans la barre d'adresse. Dans Firefox : tape about:addons.",
        },
        {
          title: "Active le mode développeur",
          desc: "Chrome uniquement — active le bouton « Mode développeur » en haut à droite.",
        },
        {
          title: "Charge l'extension",
          desc: "Chrome : « Charger l'extension non empaquetée » puis sélectionne le dossier extrait. Firefox : « Installer depuis un fichier » puis sélectionne le ZIP.",
        },
        {
          title: "Connecte-toi",
          desc: "Clique sur l'icône de l'extension et connecte-toi avec ton compte ReadingTK.",
        },
      ]
    : [
        {
        ...
        },
        {
          ...
          desc: "In Chrome: type chrome://extensions in the address bar. In Firefox: type about:addons.",
        },
        {
          title: "Enable developer mode",
          desc: "Chrome only — toggle the 'Developer mode' button in the top right.",
        },
        {
          title: "Load the extension",
          desc: "Chrome: click 'Load unpacked' and select the extracted folder. Firefox: click 'Install Add-on From File' and select the ZIP.",
        },
        {
          title: "Sign in",
          desc: "Click the extension icon and sign in with your ReadingTK account.",
        },
      ];
      ...
      <div className="mx-auto w-full max-w-4xl flex-1 px-6 py-16">
        ...
        <section className="mb-20">
          ...
          <div className="mb-10 grid gap-5 md:grid-cols-2">
            {/* Chrome */}
            <div
              className="flex flex-col gap-4 rounded-2xl border border-border bg-card/60 p-6"
            ...
            >
              ...
              {CHROME_STORE_URL ? (
                ...
                >
                  <ExternalIcon />{" "}
                  {isFr ? "Installer depuis le Chrome Web Store" : "Install from Chrome Web Store"}
                </a>
              ) : (
              ...
              <a
                href="/downloads/readingtk-chrome.zip"
                download
              ...
              >
                <DownloadIcon />{" "}
                {isFr
                  ? "Télécharger le ZIP (installation manuelle)"
            ...
            >
              ...
              >
                <ExternalIcon />{" "}
                {isFr ? "Installer depuis Firefox Add-ons" : "Install from Firefox Add-ons"}
              </a>
              <a
                href="/downloads/readingtk-firefox.zip"
                download
                className="flex items-center justify-center gap-2 rounded-md border border-border bg-card/50 px-4 py-2 text-sm font-medium text-muted-foreground transition hover:border-accent/60 hover:text-foreground"
              >
                <DownloadIcon />{" "}
          ...
          <div className="mb-10 flex flex-col items-start gap-12 md:flex-row md:items-center">
            ...
            <div className="flex flex-col gap-4">
              <h3 className="text-lg font-semibold">
                {isFr ? "Ce que fait l'extension" : "What the extension does"}
              </h3>
              {(isFr
                ? [
          ...
          <div className="rounded-2xl border border-border bg-card/40 p-8">
            <h3 className="mb-6 text-lg font-semibold">
              {isFr
                ? "Installation manuelle (Chrome, en attendant la validation du store)"
                : "Manual installation (Chrome, while awaiting store approval)"}
            </h3>
        ...
        <section>
          ...
          <div
            className="mb-10 flex items-center gap-3 rounded-2xl border border-border bg-card/60 p-6"
            style={{ boxShadow: "var(--shadow-card)" }}
          >
            <WindowsIcon />
            <div>
              ...
              <div className="text-xs text-muted-foreground">
                {isFr ? `Version ${WINDOWS_VERSION}` : `Version ${WINDOWS_VERSION}`}
              </div>
            </div>
          </div>
          ...
          <div className="mb-10 grid gap-5 md:grid-cols-3">
            <a
              href={`${RELEASE_BASE}/ReadingTK-Setup-${WINDOWS_VERSION}.exe`}
            ...
            >
              ...
              <div className="font-semibold">
                {isFr ? "Installateur (recommandé)" : "Installer (recommended)"}
              </div>
              <div className="text-xs text-muted-foreground">
                {isFr
            ...
            <a
              href={`${RELEASE_BASE}/ReadingTK-${WINDOWS_VERSION}-win64.msi`}
            ...
            <a
              href={`${RELEASE_BASE}/ReadingTK-${WINDOWS_VERSION}-portable.zip`}
              className="flex flex-col items-center gap-2 rounded-2xl border border-border bg-card/60 p-6 text-center transition hover:border-accent/60"
              style={{ boxShadow: "var(--shadow-card)" }}
            >
              <div className="mb-1 flex h-10 w-10 items-center justify-center rounded-lg bg-accent/10 text-accent">
          ...
          <div className="mb-10 rounded-xl border border-amber-500/30 bg-amber-500/10 p-4 text-sm">
            <p className="mb-1 font-medium text-foreground">
              {isFr
                ? "⚠️ Windows peut afficher un avertissement SmartScreen"
          ...
          <div className="flex flex-col gap-4">
            <h3 className="text-lg font-semibold">
              {isFr ? "Ce que fait l'application" : "What the app does"}
            </h3>
            {(isFr
              ? [
        ...
        <section
          className="flex items-center justify-between gap-4 rounded-2xl border border-border bg-card/60 p-6"
          style={{ boxShadow: "var(--shadow-card)" }}
        >
          <div>
